...
INPUT_CANDIDATES = [
    Path("Fasting_ss_output") / "glycogen_distribution_combined_threshold_0p85.csv",
    Path("Fasting_ss_output") / "glycogen_distribution_combined_threshold_0p85.csv",
]

OUTPUT_XLSX = Path("Fasting_ss_output") / "glycogen_distribution_stereology_threshold_0p85_adj.xlsx"
...
def _pick_input_file() -> Path:
    ...
    raise FileNotFoundError(
        ...
        "Fasting_ss_output or Fasting_ss_output."
    )
